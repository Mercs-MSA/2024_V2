//used code from team 7028, thank you!!!
package frc.robot.subsystems.vision;

import static edu.wpi.first.units.Units.Meters;
import static frc.robot.Constants.Vision.APRILTAG_AMBIGUITY_THRESHOLD;
import static frc.robot.Constants.Vision.FIELD_LENGTH;
import static frc.robot.Constants.Vision.FIELD_WIDTH;
 ...
 */
public class ApriltagVision implements Runnable {
  ...
  public ApriltagVision(String[] cameraNames, Transform3d[] robotToCameras, BiConsumer<Pose2d, Double> poseConsumer,
    ...
    PortForwarder.add(5800, "10.63.69.11", 5800);
    PortForwarder.add(1181, "10.63.69.11", 1181);
    PortForwarder.add(1182, "10.63.69.11", 1182);
    PortForwarder.add(1183, "10.63.69.11", 1183);
    PortForwarder.add(1184, "10.63.69.11", 1184);
    PortForwarder.add(1185, "10.63.69.11", 1185);
    PortForwarder.add(1186, "10.63.69.11", 1186);
    PortForwarder.add(1187, "10.63.69.11", 1187);
    PortForwarder.add(1188, "10.63.69.11", 1188);
