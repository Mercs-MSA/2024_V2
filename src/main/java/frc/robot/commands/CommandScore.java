...
public class CommandScore extends Command {
    ...
    public CommandScore(Pivot m_pivot, Amper m_amper, Index m_index, Shooter m_shooter, AmperMotor m_amperMotor) {
    ...
    public void initialize() {
        ...
        if (ScoringConstants.currentScoringMode == ScoringConstants.ScoringMode.AUTOAIM){
            m_pivot.leaderGoToPosition(Constants.Vision.pivotAngleCalculator(Swerve.poseEstimator.getEstimatedPosition()));
        }
        else {
