...
public class CommandShooterStartAuto extends Command {
  private final Shooter m_shooter;
  private double motor1;
  private double motor2;


  public CommandShooterStartAuto(Shooter i, double motor1, double motor2) {
    m_shooter = i;
    this.motor1 = motor1;
    this.motor2 = motor2;
  ...
  public CommandShooterStartAuto(Shooter i) {
    m_shooter = i;
  ...
  public boolean isFinished() {
    return ((Math.abs(m_shooter.getshooterMotorSpeed() - motor1) <= 60) || (Math.abs(m_shooter.getshooterMotor1Speed() - motor2) <= 60));
  }
}
